...
export class MembershipService extends ApiService {
  ...
  createMembership(payload: any): Observable<Membership> {
    return this.http.post<Membership>(this.endpoint, payload);
  }

  updateMembership(id: number | string, payload: any): Observable<Membership> {
    const endpoint = this.endpoint + '/' + id;
    return this.http.put<Membership>(endpoint, payload);
  }
  ...
  getMemberships(
    ...
    return this.http.get<Membership[]>(this.endpoint, {
      params: new HttpParams().set('page', page).set('take', take),
    });
  }

  getMembershipById(id: number | string): Observable<Membership> {
    const endpoint = `${this.endpoint}/${id}`;
    return this.http.get<Membership>(endpoint);
  }
}
