...
export const statusLabels: StatusLabels = {
  [ContributionType.Membership]: ContributionType.Membership,
  [ContributionType.Monthly]: ContributionType.Monthly,
  [ContributionType.BereavedMember]: ContributionType.BereavedMember,
  [ContributionType.DeceasedMember]: ContributionType.DeceasedMember,
...
export const statusColors: StatusColors = {
  ...
  [ContributionType.BereavedMember]: 'teal',
  [ContributionType.DeceasedMember]: 'black',
  [ContributionType.MembershipReactivation]: 'cornflowerblue',
};
